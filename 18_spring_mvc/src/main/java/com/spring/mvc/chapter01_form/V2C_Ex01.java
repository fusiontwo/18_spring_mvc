...
public class V2C_Ex01 {
	...
	//405 (get,post불일치)    404(url or jsp경로 불일치)
	@PostMapping("/modelAttributeEx")
	//public String modelAttributeEx(ProductDTO productDTO) {
	public String modelAttributeEx(@ModelAttribute ProductDTO productDTO) { // 400(파라메타 불일치)
		
		System.out.println("\n @ModelAttribute \n");
		System.out.println(productDTO);
		System.out.println();
		
		return "redirect:input"; //404(url or jsp경로 불일치)
