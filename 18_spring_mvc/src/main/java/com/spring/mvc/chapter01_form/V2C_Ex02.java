...
public class V2C_Ex02 {
	...
	//public String requestParam(String productCd , long orderQty) {
	//public String requestParam(@RequestParam(name = "productCd" , defaultValue = "0x000") String productCd ,  @RequestParam(name = "orderQty" , defaultValue = "777") long orderQty) {
	public String requestParam(@RequestParam("productCd") String productCd , @RequestParam("orderQty") long orderQty) {
	...
	public String pathVariable(@PathVariable String productCd , @PathVariable long orderQty) {
